...
public class LocationUpdatesService extends Service {
    ...
    private void startAlarm() {
        ...
        try {
            ...
            Uri selectedCustomTuneUri = SetAlarmTuneActivity.getSelectedCustomTuneUri();
            if (selectedCustomTuneUri != null) {
                mPlayer.setDataSource(this, selectedCustomTuneUri);
            } else {
                String defaultRingtone = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALARM).toString();
                mPlayer.setDataSource(this, Uri.parse(defaultRingtone));
            }
